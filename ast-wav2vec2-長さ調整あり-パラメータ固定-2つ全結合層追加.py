...
from model import Model_wav2vec, AST_Vector_160_not, CombinedClassifier_2layer_add
...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):        
        ...
        torch.save(mix_model.state_dict(), os.path.join(
            '/home/haruto/SSL_Anti-spoofing/models/ast-wav2vec2-長さ調整あり-パラメータ固定-2つ全結合層追加', 'epoch_{}.pth'.format(epoch)))